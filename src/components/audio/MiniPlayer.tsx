...
export function MiniPlayer() {
  ...
  return (
    <div
      className="fixed left-0 right-0 z-[45] h-16 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-t shadow-lg transition-all duration-300 flex justify-center"
