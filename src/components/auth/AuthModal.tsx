            ...
            <motion.div key={authScreen} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
              ...
              <div className="space-y-4 mt-6">
                ...
                <button
                  ...
                  className="w-full h-12 rounded-xl gradient-emerald text-white font-semibold shadow-glow hover:shadow-lg transition-shadow active:scale-[0.98]"
                >
                ...
                {authScreen === 'login' && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button className="h-11 rounded-xl border flex items-center justify-center gap-2 text-sm font-medium transition-colors hover:bg-gray-50 dark:hover:bg-gray-800" style={{ borderColor: 'var(--border-color)', color: 'var(--text-primary)' }}>
                      ...
                      <button className="h-11 rounded-xl bg-black text-white flex items-center justify-center gap-2 text-sm font-medium">
