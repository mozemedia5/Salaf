...
export function HomeView() {
  ...
  useEffect(() => {
    const cq = query(collection(db, 'campaigns'), orderBy('createdAt', 'desc'), limit(1));
  ...
  return (
    <div className="pb-4">
      ...
      {/* Banner Carousel Section (Appears right after the Hero Section) */}
      ...
      {campaigns.length > 0 && (
        <div className="mt-8 px-4">
          <SectionHeader title="Support Our Cause" action="View All" onAction={() => setActiveTab('donate')} />
